...
int main(int argc , char** argv) {
    ...
    fftwl_plan p = fftwl_plan_dft_r2c_1d(N, ft_data2.data(), reinterpret_cast<fftwl_complex*>(out.data()), FFTW_ESTIMATE);
    //fftwl_plan p = fftwl_plan_dft_1d(N, reinterpret_cast<fftwl_complex*>(cmp), reinterpret_cast<fftwl_complex*>(out.data()), FFTW_FORWARD, FFTW_ESTIMATE);
