...
/**
 * @brief Ensures the default AudioBuffer constructor works
 * 
 */
...
/**
 * @brief Ensures the AudioBuffer constructor with a single channel works
 * 
 */
...
/**
 * @brief Ensures the AudioBuffer constructor with multiple channels works
 * 
 */
TEST(AudioBufferTest, ConstructMulti) {
    ...
    const std::vector<AudioChannel> tdata = data;

    // Create an AudioBuffer with multiple channels:

    AudioBuffer buff(tdata);
...
/**
 * @brief Ensures AudioBuffer sample rate methods work correctly
 * 
 */
...
/**
 * @brief Ensures the AudioBuffer size method works correctly
 * 
 */
...
/**
 * @brief Ensures the AudioBuffer interleaved iterator read operations work correctly
 * 
 */
...
/**
 * @brief Ensures the AudioBuffer sequential iterator read operations work correctly
 * 
 */
...
/**
 * @brief Ensures the AudioBuffer interleaved iterator write operations work correctly
 * 
 */
...
/**
 * @brief Ensures the AudioBuffer sequential iterator write operations work correctly
 * 
 */
...
/**
 * @brief Ensures the AudioBuffer interleaved iterator seek operations work correctly
 * 
 */
...
/**
 * @brief Ensures the AudioBuffer sequential iterator seek operations work correctly
 * 
 */
...
TEST(RingBufferTest, Access) {
    ...
    const std::vector<long double> tdata = chan1;

    // Create a RingBuffer:

    RingBuffer<long double> ring(tdata);
