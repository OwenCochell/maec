...
public:
     ...
     *
     */
    BaseOscillator(double freq, double pha) : phase(pha), freq(freq) {}
     ...
     *
     */
    BaseOscillator(double freq) : freq(freq) {}
...
public:
     ...
     *
     */
    BaseModulatedOscillator(double freqv, double pha)
     ...
     *
     */
    BaseModulatedOscillator(double freqv)
