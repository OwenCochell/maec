...
std::vector<double> ft_data = {
    ...
    -16.2175099999997593923, -10.9511700000003418193, -61.7699399999997511741,
    -69.2286100000000882773, 0.421569999999996698238, 37.6517800000001357057,
    80.4401700000000488971,  -2.04557000000011644271, -85.9569899999997715442,
    2.72508999999991183543,  -66.3554300000000642709, -2.34488999999995559407,
    -40.3914900000000819981, -3.64987999999990044789, -17.7549800000004358823,
    71.0510400000002124293,  -48.0264400000000275734, 110.045180000000132392,
    -105.146259999999952539, -56.3275699999998687544, 95.8438100000005266874,
    64.2721399999995513172,  -43.4969999999996350254, -16.9237900000002831694,
    -109.863809999999695023, 84.7972800000000368273,  77.4762800000004462145,
    57.2437800000003134647,  -110.995029999999789382, -55.1876299999999012057,
    -95.6075800000002865298, 75.4721999999997809339,  -12.7008200000005678967,
    -36.9976999999999474796, -49.1758900000000834345, -71.2256300000002166503,
    108.823060000000235506,  -110.420349999999915749, 90.9002899999999186831,
...
const std::vector<std::complex<double>> cft_data = {
    std::complex<double>(-15.189251, 0.000000),
    std::complex<double>(11.704489, -7.808442),
    std::complex<double>(-0.090070, 10.845936),
    std::complex<double>(-11.697811, -5.706792),
    std::complex<double>(-2.788215, 7.507124),
    std::complex<double>(8.873675, -10.790867),
    std::complex<double>(-5.838451, 2.531785),
    std::complex<double>(4.630811, -6.716717),
    ...
    std::complex<double>(7.972179, -6.781337),
    std::complex<double>(0.624014, -5.571347),
    std::complex<double>(4.138358, -0.394291),
    std::complex<double>(-1.130739, 0.000000),
    std::complex<double>(4.138358, 0.394291),
    std::complex<double>(0.624014, 5.571347),
    std::complex<double>(7.972179, 6.781337),
    std::complex<double>(-4.071020, -15.037189),
...
const std::vector<std::complex<double>> cft_output = {
    std::complex<double>(47.8646, 0),
    std::complex<double>(-60.679, 0),
    std::complex<double>(-65.8105, 0),
    std::complex<double>(69.5778, 0),
    std::complex<double>(99.7526, 0),
    std::complex<double>(-90.287, 0),
    std::complex<double>(36.9178, 0),
    std::complex<double>(80.6327, 0),
    std::complex<double>(-88.2723, 0),
    std::complex<double>(-62.5006, 0),
    std::complex<double>(-76.6374, 0),
    std::complex<double>(-52.985, 0),
    std::complex<double>(-46.0648, 0),
    std::complex<double>(-86.605, 0),
    std::complex<double>(-68.5806, 0),
    std::complex<double>(-56.903, 0),
    std::complex<double>(-97.7982, 0),
    std::complex<double>(24.3152, 0),
    std::complex<double>(58.614, 0),
    std::complex<double>(89.4592, 0),
    std::complex<double>(-55.8749, 0),
    std::complex<double>(-93.1961, 0),
    std::complex<double>(19.1352, 0),
    std::complex<double>(-77.2428, 0),
    std::complex<double>(25.5402, 0),
    std::complex<double>(54.4226, 4.33681e-19),
    std::complex<double>(-49.1747, 0),
    std::complex<double>(80.9814, 0),
    std::complex<double>(-0.730811, 0),
    std::complex<double>(-43.9266, 0),
    std::complex<double>(-1.95563e-07, -2.1684e-19),
    std::complex<double>(6.6234926488113743e-07, 0)};

// Known real data (power of 2)
std::vector<double> ft2_data = {
...
// Known complex result:
std::vector<std::complex<double>> ft2_output = {
    std::complex<double>(-43.664541595800022, 0),
    std::complex<double>(359.45181848469754, -565.11450941061558),
    std::complex<double>(8.6293957918963725, -753.12168792311656),
    std::complex<double>(-46.863123137862357, -131.23397931250944),
    std::complex<double>(239.56283276052127, -481.96012333692197),
    std::complex<double>(224.101183608534, -1016.8846705832734),
    std::complex<double>(-509.15587956189165, -464.98325585412137),
    std::complex<double>(-389.00758691682769, 224.57211055070545),
    std::complex<double>(264.70720400647352, -274.02490505960353),
    std::complex<double>(-93.651889962216083, -417.15007283068046),
    std::complex<double>(275.92137264991444, 368.38896499036456),
    std::complex<double>(466.14362933356768, -209.80187776532449),
    std::complex<double>(-402.08144966580375, 93.785616391165261),
    std::complex<double>(62.754539854000547, -189.2984833849671),
    std::complex<double>(-288.70843453473079, 107.18804062488756),
    std::complex<double>(464.62263270044914, -213.62987034748249),
    std::complex<double>(38.595183674499992, 478.88317332010003),
    std::complex<double>(-518.36322233252044, -153.35268279949373),
    std::complex<double>(326.60869521036493, -30.208229145220096),
    std::complex<double>(100.10624013796194, 414.4482393462402),
    std::complex<double>(24.120287213970933, -761.33411973294775),
    std::complex<double>(-240.17910982830549, 805.60902291646104),
    std::complex<double>(158.69833481771356, 60.469890206290065),
    std::complex<double>(-21.543578704467073, -320.99769573919335),
    std::complex<double>(414.07990225872646, 328.19458281099647),
    std::complex<double>(-252.32542782790214, -302.63466451478207),
    std::complex<double>(-557.5731385339072, 45.443397832052496),
    std::complex<double>(-293.40889713883586, 118.58242620276572),
    std::complex<double>(-335.50810291108844, 142.55294889496504),
    std::complex<double>(426.81576634412209, 143.20747673715266),
    std::complex<double>(69.173563266240378, -417.26860597337583),
    std::complex<double>(-303.8423926719958, 206.59293747939968),
    std::complex<double>(80.810036274799974, 0)};
 ...
 */
void compare_complex(std::complex<double> first, std::complex<double> second) {

    // Compare real part:

    REQUIRE_THAT(first.real(),
                 Catch::Matchers::WithinAbs(second.real(), 0.0001));

    // Compare imaginary parts:

    REQUIRE_THAT(first.imag(),
                 Catch::Matchers::WithinAbs(second.imag(), 0.0001));
}
 ...
 * @param out Iterator to output array
 */
void rand_real(int size, std::vector<double>::iterator out) {
...
TEST_CASE("DFT", "[ft][dsp]") {
    ...
    SECTION("Random", "Ensures random data can be transformed and reversed") {
        ...
        for (int i = 0; i < size; ++i) {
            ...
            REQUIRE_THAT(nums.at(i),
                         Catch::Matchers::WithinAbs(output.at(i), 0.0000001));
        }
    }
...
TEST_CASE("FFT2", "[ft][dsp]") {
    ...
    SECTION("Out of place", "Tests the out of place algorithm") {
        ...
        SECTION("Forward", "Ensures the FFT2 algorithm works on known data") {
            ...
            std::vector<std::complex<double>> out(output_length);
        ...
        SECTION("Inverse",
                "Ensures the iFFT2 algorithm works with known data") {
        ...
        SECTION("Random", "Ensures the FFT2 algorithm works on random data") {
            ...
            std::vector<std::complex<double>> rdata(size);
            std::vector<std::complex<double>> output(size);
            std::vector<std::complex<double>> final_data(size);
    ...
    SECTION("Real", "Tests for the real FFT2 algorithm") {
        ...
        SECTION("Forward", "Ensures the forward algorithm works") {
            ...
            std::vector<std::complex<double>> out(osize);
        ...
        SECTION("Inverse", "Ensures the inverse algorithm works") {
            ...
            for (int i = 0; i < osize; ++i) {
                ...
                REQUIRE_THAT(ft2_data.at(i),
                             Catch::Matchers::WithinAbs(out.at(i), 0.00001));
            }
        }
    }
}
